...
const data = {
  nav: [
    { name: "summary", icon: FileText, href: "/patient-profile/summary" },
    { name: "full info", icon: IdCard, href: "/patient-profile" },
    { name: "history", icon: History, href: "/patient-profile/history" },
    { name: "vital signs", icon: Activity, href: "/patient-profile/vital-signs" },
    { name: "prescriptions", icon: Pill, href: "/patient-profile/prescriptions" },
    { name: "services", icon: Stethoscope, href: "/patient-profile/services" },
    { name: "invoices", icon: FileArchiveIcon, href: "/patient-profile/invoices" },
  ],
}
