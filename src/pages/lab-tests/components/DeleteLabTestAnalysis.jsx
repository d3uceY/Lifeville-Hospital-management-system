...
export default function DeleteLabTestAnalysisDialog({ deletedLabTestAnalysisRecordInfo }) {
    ...
    const handleDeleteLabTestAnalysis = async () => {
        ...
        toast.promise(promise(), {
            loading: 'Deleting lab test analysis...',
            success: `Lab test analysis deleted successfully`,
        ...
        <AlertDialog>
            ...
            <AlertDialogContent className="border-t-4 border-t-[#106041] max-w-md">
                ...
                <AlertDialogHeader className="pt-6">
                    ...
                    <AlertDialogDescription className="text-center">
                        ...
                        <span className="text-gray-600 block">
                            This will permanently delete the lab test record.
                        </span>
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <div className="bg-amber-50 border-l-4 border-amber-400 p-3 my-2 text-sm text-amber-800">
                    ...
                    <p>
                        Deleting this lab test may affect patient assignments and hospital records. Ensure you have proper authorization before proceeding.
                    </p>
                </div>
                <AlertDialogFooter className="flex items-center gap-2">
                    ...
                    <AlertDialogAction
                        onClick={handleDeleteLabTestAnalysis}
