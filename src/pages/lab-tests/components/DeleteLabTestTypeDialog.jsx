...
import { deleteLabTestType } from "../../../providers/ApiProviders";
import { useLabTests } from "../../../providers/ApiContextProvider";
import { toast } from "sonner";

export default function DeleteLabTestTypeDialog({ deletedLabTestTypeRecordInfo }) {
    const { refreshLabTestTypes } = useLabTests();
    const { id, name } = deletedLabTestTypeRecordInfo;


    const handleDeleteLabTestType = async () => {
        const promise = async () => {
            try {
                const response = await deleteLabTestType(id);
                refreshLabTestTypes();
                return response;
            } catch (err) {
                throw err;
        ...
        toast.promise(promise(), {
            loading: 'Deleting lab test type...',
            success: `Lab test type deleted successfully`,
        ...
        <AlertDialog>
            ...
            <AlertDialogContent className="border-t-4 border-t-[#106041] max-w-md">
                ...
                <AlertDialogHeader className="pt-6">
                    ...
                    <AlertDialogDescription className="text-center">
                        ...
                        <span className="text-gray-600 block">
                            This will permanently delete the lab test type record.
                        </span>
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <div className="bg-amber-50 border-l-4 border-amber-400 p-3 my-2 text-sm text-amber-800">
                    ...
                    <p>
                        Deleting this lab test type may affect patient assignments and hospital records. Ensure you have proper authorization before proceeding.
                    </p>
                </div>
                <AlertDialogFooter className="flex items-center gap-2">
                    ...
                    <AlertDialogAction
                        onClick={handleDeleteLabTestType}
