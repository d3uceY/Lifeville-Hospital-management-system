...
import { deleteBed } from "../../../providers/ApiProviders";
import { useBeds } from "../../../providers/ApiContextProvider";
import { toast } from "sonner";

export default function DeleteBedDialog({ deletedBedRecordInfo }) {
    const { refreshBeds } = useBeds();
    const { id, bed_name } = deletedBedRecordInfo;
    ...
    return (
        <AlertDialog>
            <AlertDialogTrigger asChild>
                <Button
                    variant="outline"
                    className="flex justify-start px-0 py-0 bg-red-100 w-fit items-center cursor-pointer border-0 outline-0 text-red-600 hover:bg-red-50 hover:text-red-700 focus:bg-red-50 focus:text-red-700"
                >
            ...
            <AlertDialogContent className="border-t-4 border-t-[#106041] max-w-md">
                ...
                <AlertDialogHeader className="pt-6">
                    ...
                    <div className="mt-2 mb-4 bg-[#f0f8f4] border border-[#106041]/30 rounded-md p-3 text-center">
                        <div className="flex items-center justify-center mb-1">
                            ...
                            <span className="font-bold text-[#106041]">{bed_name}</span>
                        </div>
                ...
                <div className="bg-amber-50 border-l-4 border-amber-400 p-3 my-2 text-sm text-amber-800">
                    ...
                    <p>
                        Deleting this bed may affect patient assignments and hospital records. Ensure you have proper authorization before proceeding.
                    </p>
                </div>
