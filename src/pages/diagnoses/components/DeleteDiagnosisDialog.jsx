...
import { deleteDiagnoses } from "../../../providers/ApiProviders";
import { toast } from "sonner";
import { useQueryClient } from "@tanstack/react-query";
import { useParams } from "react-router-dom";

export default function DeleteDiagnosisDialog({ deletedDiagnosisRecordInfo }) {
    const { diagnosis_id, condition, first_name, surname } = deletedDiagnosisRecordInfo;
    ...
    const handleDeleteDiagnosis = async () => {
        const promise = async () => {
            try {
                const response = await deleteDiagnoses(diagnosis_id);
        ...
        toast.promise(promise(), {
            ...
            success: () => `you have deleted diagnosis successfully`,
            ...
            <AlertDialogContent className="border-t-4 border-t-[#106041] max-w-md">
                ...
                <AlertDialogHeader className="pt-6">
                    <AlertDialogTitle className="text-center text-xl font-bold">
                        Delete Diagnosis for {first_name} {surname}
                    </AlertDialogTitle>
                    ...
                    <AlertDialogDescription className="text-center">
                        ...
                        <span className="text-gray-600 block">
                            This will permanently delete the diagnosis record.
                        </span>
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <div className="bg-amber-50 border-l-4 border-amber-400 p-3 my-2 text-sm text-amber-800">
                    ...
                    <p>
                        Deleting this diagnosis may affect patient assignments and hospital records. Ensure you have proper authorization before proceeding.
                    </p>
                </div>
