...
import { deleteCondition } from "../../../providers/ApiProviders";
import { useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";

export default function DeleteConditionDialog({ deletedConditionInfo }) {
    const queryClient = useQueryClient();
    const { condition_id, name } = deletedConditionInfo;

    const handleDeleteCondition = async () => {
        const promise = async () => {
            try {
                const response = await deleteCondition(condition_id);
        ...
        <AlertDialog>
            ...
            <AlertDialogContent className="border-t-4 border-t-[#106041] max-w-md">
                ...
                <AlertDialogHeader className="pt-6">
                    ...
                    <AlertDialogDescription className="text-center">
                        ...
                        <span className="text-gray-600 block">
                            This will permanently delete the condition record.
                        </span>
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <div className="bg-amber-50 border-l-4 border-amber-400 p-3 my-2 text-sm text-amber-800">
                    ...
                    <p>
                        Deleting this condition will remove it from future diagnosis selections. Ensure you have proper authorization before proceeding.
                    </p>
                </div>
