...
import { deleteSymptomType } from "../../../providers/ApiProviders";
import { useSymptomTypes } from "../../../providers/ApiContextProvider";
import { toast } from "sonner";


export default function DeleteSymptomTypeDialog({ children, deletedSymptomTypeRecordInfo }) {

    const { refreshSymptomTypes } = useSymptomTypes();
    const { symptom_text, symptom_type_id } = deletedSymptomTypeRecordInfo;

    const handleDeleteSymptomType = async () => {
        const promise = async () => {
            try {
                const response = await deleteSymptomType(symptom_type_id);
                refreshSymptomTypes();
                return response;
            } catch (err) {
                throw err;
        ...
        <AlertDialog>
            ...
            <AlertDialogContent className="border-t-4 border-t-[#106041] max-w-md">
                ...
                <AlertDialogHeader className="pt-6">
                    ...
                    <AlertDialogDescription className="text-center">
                        ...
                        <span className="text-gray-600 block">
                            This will parmanently delete the symptom type.
                        </span>
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <div className="bg-amber-50 border-l-4 border-amber-400 p-3 my-2 text-sm text-amber-800">
                    ...
                    <p>
                        Deleting this may have legal and medical implications. Ensure you have proper authorization
                        before proceeding.
                    </p>
                </div>
                <AlertDialogFooter className="flex items-center gap-2 ">
                    ...
                    <AlertDialogAction
                        onClick={handleDeleteSymptomType}
