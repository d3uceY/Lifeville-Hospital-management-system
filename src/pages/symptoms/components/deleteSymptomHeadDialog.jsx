...
import { deleteSymptomHead } from "../../../providers/ApiProviders";
import { useSymptomHeads } from "../../../providers/ApiContextProvider";
import { toast } from "sonner";


export default function DeleteSymptomHeadDialog({ children, deletedSymptomHeadRecordInfo }) {

    const { refreshSymptomHeads } = useSymptomHeads();
    const { symptom_head, symptom_head_id } = deletedSymptomHeadRecordInfo;

    const handleDeleteSymptomHead = async () => {
        const promise = async () => {
            try {
                const response = await deleteSymptomHead(symptom_head_id);
                refreshSymptomHeads();
                return response;
            } catch (err) {
                throw err;
        ...
        <AlertDialog>
            ...
            <AlertDialogContent className="border-t-4 border-t-[#106041] max-w-md">
                ...
                <AlertDialogHeader className="pt-6">
                    ...
                    <AlertDialogDescription className="text-center">
                        ...
                        <span className="text-gray-600 block">
                            This will parmanently delete the symptom head.
                        </span>
                    </AlertDialogDescription>
                </AlertDialogHeader>
                ...
                <AlertDialogFooter className="flex items-center gap-2 ">
                    ...
                    <AlertDialogAction
                        onClick={handleDeleteSymptomHead}
